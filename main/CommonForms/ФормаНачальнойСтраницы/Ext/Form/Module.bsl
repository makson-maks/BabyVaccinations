...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.СтраницаБлижайшиеСобытия.Заголовок = "Ближайшие " + Символы.ПС + "события";
...
&НаКлиенте
Процедура ПланировщикКалендарьПрививокПриОкончанииРедактирования(Элемент, НовыйЭлемент, ОтменаРедактирования)
